...
export const CollaboratorPartners: React.FC<CollaboratorPartnersProps> = ({ data }) => {
  return (
    <section className="relative overflow-hidden rounded-3xl bg-bg-elevated/40 p-5 sm:p-10 md:p-14 max-w-6xl mx-auto backdrop-blur-xl flex flex-col items-center justify-center text-center space-y-8 sm:space-y-12">
      {/* Background Glow */}
      <div
      ...
      {/* Main Header (Cleaned: No Sinemus Network Badge) */}
      <div className="space-y-3 max-w-3xl mx-auto flex flex-col items-center z-10">
