  ...
  return (
    <section className="w-full bg-blue-600 text-white py-10 sm:py-14 px-6 sm:px-12 my-4 shadow-sm">
      <div className="w-full max-w-7xl mx-auto">
        <div className="flex flex-wrap items-center justify-center gap-8 sm:gap-16 lg:gap-24 text-center mx-auto">
          {stats.map((st, i) => (
            <div key={i} className="flex flex-col items-center justify-center min-w-[130px] sm:min-w-[170px] space-y-1.5 group">
