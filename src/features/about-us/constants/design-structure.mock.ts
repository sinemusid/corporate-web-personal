...
export const MOCK_DESIGN_STRUCTURE: DesignStructureData = {
  ...
  nodes: [
    // Level 1: CEO
    {
      ...
      description: 'Strategic Planning, Leadership, Big-picture Expansion',
      level: 1,
    },
    // Level 2: C-Suite Officers
    {
      ...
      description: 'Operations, Legal Compliance & HR Governance',
      parentRole: 'CEO',
      level: 2,
    },
    {
    ...
    },
    {
      ...
      description: 'Technology Infrastructure & Digital Platform',
      parentRole: 'CEO',
      level: 2,
    },
    {
      ...
      description: 'Marketing Campaign & User Acquisition',
      parentRole: 'CEO',
      level: 2,
    },
