    ...
    <div className="space-y-10 max-w-5xl mx-auto py-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 sm:gap-6">
        {data.stats.map((stat, idx) => (
          <div
            key={idx}
            className="p-6 sm:p-8 rounded-2xl sm:rounded-3xl border border-slate-200 bg-white text-center flex flex-col justify-center items-center space-y-3 hover:border-blue-500 hover:shadow-xl transition-all duration-200 group"
          >
