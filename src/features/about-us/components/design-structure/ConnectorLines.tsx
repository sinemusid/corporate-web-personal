...
export const JointDot: React.FC<{ className?: string }> = ({ className = '' }) => (
  <div className={`w-2.5 h-2.5 rounded-full bg-blue-600 z-20 ${className}`} />
);
...
export const DesktopCSuiteBusLine: React.FC = () => (
  <div className="hidden lg:block absolute top-0 left-[12%] right-[12%] h-px bg-slate-300" />
);

/** Tablet C-Suite Horizontal Bus Line (2 Columns) */
export const TabletCSuiteBusLine: React.FC = () => (
  <div className="hidden md:block lg:hidden absolute top-0 left-[25%] right-[25%] h-px bg-slate-300" />
);

/** Column Vertical Stem from Bus Line down into Card */
export const ColumnTopLine: React.FC = () => (
  <div className="hidden md:block absolute top-0 w-px h-9 bg-slate-300" />
);
