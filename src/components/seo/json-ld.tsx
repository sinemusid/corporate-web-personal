    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: 'Screen Unit',
        description: 'Layanan penayangan film, platform streaming, dan manajemen ticketing event sinema.',
        url: `${productionBase}/units/screen`,
      },
      {
        '@type': 'SiteNavigationElement',
        position: 2,
        name: 'Production Unit',
        description: 'Studio produksi film layar lebar, dokumenter, dan konten audio visual profesional.',
        url: `${productionBase}/units/production`,
      },
      {
        '@type': 'SiteNavigationElement',
        position: 3,
        name: 'Academy Unit',
        description: 'Inkubator, workshop kreatif, dan pusat pelatihan talenta perfilman masa depan.',
        url: `${productionBase}/units/academy`,
      },
      {
        '@type': 'SiteNavigationElement',
        position: 4,
        name: 'Community Unit',
        description: 'Wadah jejaring sineas independen, apresiasi karya, dan forum kolaborasi film.',
        url: `${productionBase}/units/community`,
      },
      {
        '@type': 'SiteNavigationElement',
        position: 5,
        name: 'Tentang Kami',
        description: 'Mengenal profil Sinemus Indonesia, visi misi, struktur tim, dan rekam jejak portofolio.',
      ...
      },
      {
        ...
        position: 6,
        name: 'Hubungi Kami',
        description: 'Hubungi Sinemus Indonesia untuk kemitraan corporate, kolaborasi, dan konsultasi proyek.',
